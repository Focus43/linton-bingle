...
<div class="skinny-wrap">
    <div class="property-search">
        ...
        <form id="propertySearch" method="get" action="<?php echo View::url('properties'); ?>" class="clearfix">
            ...
            <p class="big-match"><strong><span class="target-result-count">26</span> properties</strong></p>
            <p>There are <strong><span class="target-result-count"><?php echo $pagingHelper->resultCount; ?>26</span> properties</strong> matching your search criteria.</p>
