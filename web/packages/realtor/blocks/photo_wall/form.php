...
<div id="photoWall">
    <div class="controls-wrap">
        <div class="inner">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-3">
                        <?php echo $form->select('fileSource', \Concrete\Package\Realtor\Block\PhotoWall\Controller::$fileSourceOptions, $this->controller->fileSource); ?>
                    </div>
                    <div class="col-sm-9" data-source-method="<?php echo \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_CUSTOM; ?>">
                        <button type="button" class="btn btn-default btn-block" add-file>Add Image</button>
                    </div>
                    <div class="col-sm-9" data-source-method="<?php echo \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_SET; ?>">
    ...
    <div class="selected-wrap">
        <div class="inner" chosen-files data-source-method="<?php echo \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_CUSTOM; ?>">
            <?php if((int)$this->controller->fileSource === \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_CUSTOM):
        ...
        <div class="inner" chosen-files data-source-method="<?php echo \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_SET; ?>">
            <?php if((int)$this->controller->fileSource === \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_SET):
                foreach($fileListResults AS $file){
...
<script type="text/javascript">
    $(function(){
        _photoWallHandler({
            sourceMethod: {
                custom: <?php echo \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_CUSTOM; ?>,
                fileSet: <?php echo \Concrete\Package\Realtor\Block\PhotoWall\Controller::FILE_SOURCE_SET; ?>
            },
